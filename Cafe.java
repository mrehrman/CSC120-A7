...
public class Cafe extends Building{
    ...
    /**
     * Default constructor. Only takes an address for the Cafe.
     * @param address The address for the Cafe.
     */
    ...
    /**
     * Full constructor. Creates an instance of the class Cafe.
    ...
    /**
     * Overloaded restock() restocks all Cafe inventory to default values.
     */
    private void restock(){
        this.nCoffeeOunces = this.nCoffeeOunces + 50;
        this.nSugarPackets = this.nSugarPackets + 50;
        this.nCreams = this.nCreams + 50;
        this.nCups = this.nCups + 50;
        System.out.println("You have restocked. You now have " + this.nCups + " cups, " + this.nCoffeeOunces + " ounces of coffee, " + this.nSugarPackets + " packets of sugar, and " + this.nCreams + " creams in your inventory.");
    }
